    ...
    return (
      <div style={{ minHeight: "100vh", background: "#F2F0EB", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 20px" }}>
          <div style={{ width: "100%", maxWidth: 420, background: "white", borderRadius: 16, border: "0.5px solid #e5e7eb", padding: "48px 40px", textAlign: "center" }}>
            <div style={{ width: 52, height: 52, background: "#ede9fe", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px" }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#5B3FEA" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="20 6 9 17 4 12" />
              </svg>
            </div>
            <h1 style={{ fontFamily: "'Syne', sans-serif", fontSize: 22, fontWeight: 800, color: "#111827", marginBottom: 10 }}>Check your inbox</h1>
            ...
            <p style={{ fontSize: 13, color: "#9ca3af" }}>
              No account yet?{" "}
              <Link href="/pricing" style={{ color: "#5B3FEA", fontWeight: 500 }}>See pricing</Link>
            </p>
          </div>
        </div>
      </div>
    ...
    <div style={{ minHeight: "100vh", background: "#F2F0EB", display: "flex", flexDirection: "column" }}>
      <style>{`
        @media (min-width: 900px) {
          .login-layout { flex-direction: row !important; align-items: stretch !important; }
          .login-hero { display: flex !important; }
          .login-form-wrap { max-width: 480px !important; width: 480px !important; flex-shrink: 0; }
        }
      `}</style>

      <Navbar />

      <div className="login-layout" style={{ flex: 1, display: "flex", flexDirection: "column" }}>

        {/* Form side */}
        <div className="login-form-wrap" style={{ width: "100%", background: "white", display: "flex", flexDirection: "column", padding: "40px 32px" }}>

          <div style={{ maxWidth: 380, width: "100%", margin: "0 auto", flex: 1 }}>
            <h1 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 28, color: "#111827", marginBottom: 6 }}>Welcome back</h1>
            <p style={{ fontSize: 14, color: "#6b7280", marginBottom: 28, lineHeight: 1.5 }}>
              Sign in to your dashboard and track your AI visibility.
            </p>

            {verified && (
              <div style={{ background: "#ECFDF5", border: "0.5px solid #6EE7B7", borderRadius: 8, padding: "10px 14px", marginBottom: 20, fontSize: 13, color: "#065F46" }}>
            ...
            <form onSubmit={handlePasswordLogin} style={{ marginBottom: 0 }}>
              ...
              <div style={{ textAlign: "right", marginBottom: 18 }}>
                <Link href="/forgot-password" style={{ fontSize: 13, color: "#5B3FEA", fontWeight: 500, textDecoration: "none" }}>
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                ...
                style={{ width: "100%", padding: "12px 0", background: "#5B3FEA", color: "white", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 600, cursor: loading && mode === "password" ? "not-allowed" : "pointer", opacity: loading && mode === "password" ? 0.7 : 1, transition: "opacity 0.15s" }}
              >
            ...
            {unverifiedEmail && (
              <div style={{ background: "#FEF3C7", border: "0.5px solid #FDE68A", borderRadius: 8, padding: "10px 14px", marginTop: 12, fontSize: 13, color: "#92400E" }}>
                Please verify your email first.{" "}
                <button
                  onClick={handleResendVerification}
                  disabled={resendingVerification}
                  style={{ color: "#5B3FEA", background: "none", border: "none", cursor: "pointer", fontWeight: 500, padding: 0, fontSize: 13, textDecoration: "underline" }}
                >
            ...
            <form onSubmit={handleMagicLink}>
              <button
                ...
                style={{ width: "100%", padding: "12px 0", background: "white", color: "#374151", border: "0.5px solid #d1d5db", borderRadius: 8, fontSize: 14, fontWeight: 500, cursor: loading && mode === "magic" ? "not-allowed" : "pointer", opacity: loading && mode === "magic" ? 0.7 : 1 }}
              >
            ...
            <p style={{ fontSize: 13, color: "#6b7280", marginTop: 32, textAlign: "center" }}>
              ...
              <Link href="/signup" style={{ color: "#5B3FEA", fontWeight: 600, textDecoration: "none" }}>Sign up free</Link>
            </p>

            <div style={{ marginTop: 24, borderTop: "0.5px solid #f3f4f6", paddingTop: 16 }}>
              <button
                type="button"
              ...
              {devOpen && (
                <form onSubmit={handleDevLogin} style={{ marginTop: 10, display: "flex", gap: 8 }}>
                  <input
                    type="password"
        ...
        <div className="login-hero" style={{
          ...
          <div>
            ...
            <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 40, color: "white", lineHeight: 1.15, marginBottom: 48 }}>
